...
(function($) {
    ...
    $.extend(Timer.prototype, {
        ...
        _init: function(target, options) {
            //初始时间
            if(init_dateTime != null){
                var ss = init_dateTime.split(":");
                _defaultTime = new Date(ss[0], ss[1] - 1, ss[2], ss[3], ss[4], ss[5]);
            }
            ...
            setInterval('$.timer._setValue()', 1000);
        },
