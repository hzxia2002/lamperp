					...
					'<div class="plupload">' +
						'<div class="plupload_header">' +
							'<div class="plupload_header_content">' +
								'<div class="plupload_header_title">' + _('Select files') + '<div style="display:inline;margin-left:5px; font: normal 12px sans-serif">(请选择需要上传的图片，然后点击"开始"按钮进行上传)</div></div>' +								
							'</div>' +
						'</div>' +
							...
							'<div class="plupload_filelist_footer">' +
								'<div class="plupload_file_name">' +
									'<div class="plupload_buttons">' +
										'<a href="javascript:void(0)" class="plupload_button plupload_add">' + _('选择文件') + '</a>' +
										'<a href="javascript:void(0)" class="plupload_button plupload_start">' + _('开始上传') + '</a>' +
									'</div>' +
				...
				uploader.bind("Error", function(up, err) {
					...
					if (file) {
						...
						if (err.code == plupload.FILE_SIZE_ERROR) {
							alert(_("出错了:文件大小超过限制尺寸[")+file.name+"]");
						}

						if (err.code == plupload.FILE_EXTENSION_ERROR) {
							alert(_("出错了:文件类型不对[: ") + file.name + "]");
						}
