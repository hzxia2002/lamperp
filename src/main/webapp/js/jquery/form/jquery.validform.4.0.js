/*
	...
	By sean during April 7, 2010 - December 13, 2011
...
(function($){
	...
	$.fn.Validform=function(settings){
        ...
        if(settings.showRightMsg == undefined || settings.showRightMsg == null) {
            settings.showRightMsg = false;
        }
