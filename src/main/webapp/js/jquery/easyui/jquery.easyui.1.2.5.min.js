...
var tool=$("<div class=\"panel-tool\" id=\"panel-tool-top\" onclick='adjustPageSize(\"gfrc1\");'></div>").appendTo(_176);
if(opts.tools){
...
// $.extend(_4b9,{page:opts.pageNumber,rows:opts.pageSize});
    // hzxia 修改
    $.extend(_4b9,{page:opts.pageNumber,pageSize:opts.pageSize});
}
if(opts.sortName){
// $.extend(_4b9,{sort:opts.sortName,order:opts.sortOrder});
    // hzxia 修改
    $.extend(_4b9,{orderBy:opts.sortName,order:opts.sortOrder});
}
