...
//            multiselect: true,
            ...
            gridComplete:function(){  //在此事件中循环为每一行添加修改和删除链接
                ...
                for(var i=0; i<ids.length; i++){
                    ...
                    operation += "<a href='#' style='color:#f60'  class='button'  onclick='doEdit(" + id + ")'>上传翻译文稿</a>";  //这里的onclick就是调用了上面的javascript函数 Modify(id)
        ...
        var tree = new JOTree({treeId:"taskTreeDiv"
            , menu : getMenu,
            url:"${ctx}/project/tree.do"
            ,   callback: {
...
//        JORegion.showAll();
        ...
        //tree对象
        treeObj = $.fn.zTree.getZTreeObj("projectWorkSiteTreeDiv");
    });
     ...
     */
    function doEdit(id) {
        openWindow("taskWindow", "编辑", "${ctx}/task/init.do?id=" + id, true, "taskGrid",800,540);
    }
