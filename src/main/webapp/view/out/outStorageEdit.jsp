...
//            multiselect: true,
            ...
            beforeRequest:function(){
                ...
                var ids=jQuery("#productAddGrid").jqGrid('getDataIDs');
...
//                products[productId] =  $("#perCount").val();
    ...
    function validData(){
        if(isNaN(parseInt($("#perCount").val()))){
            alert("请在产品数量输入框中请输入有效数字");
            $("#perCount").val("");
            return false;
        }else{
            $("#perCount").val(parseInt($("#perCount").val()));
        }
        return true;
    }
    ...
    function delMendForm(){
        var ids = "";
        $("#mendFormName option:selected").remove();
        $("#mendFormName option").each(function(index,option){
            ids += (!ids?$(option).val():(","+$(option).val()));
        });
        $("#mendFormIds").val(ids);
        reloadGridData(true);
    }
            ...
            <table border="0" cellspacing="1" width="100%" id="editTable">
                ...
                <tr class="cssline">
                    ...
                    <td  class="container">
                        ...
                        <img src="${ctx}/skin/icons/edit_remove.png"   onclick="delMendForm()">
                    </td>
                </tr>
                ...
                <tr class="cssline">
                    ...
                    <td  class="container">
                        <input type="text" name="outDate" class="Wdate" value="${bean.outDate}" onFocus="WdatePicker({readOnly:true})"  style="width: 100px"/>&nbsp;
                ...
                <tr class="cssline">
                    ...
                    <td  class="container">
                        <input type="text" name="hander"  id="hander" value="${bean.hander}"   style="width: 400px"/>&nbsp;
                    </td>
                </tr>
                <tr>
                    <td colspan="2" valign="middle" align="center">
                        <input type="button" id="formOutStoragebutton" value="确定" class="btn_Ok">&nbsp;
                        <input type="button" value="取消" class="btn_Del" onclick="closeWindow('outStorageWindow')">
                    </td>
                </tr>
                <tr class="cssline">
                ...
                <tr class="cssline">
                    <td  colspan="2">
                        ...
                        数量:<input type="text" name="perCount" id="perCount" onblur="validData()"/>&nbsp;&nbsp;
