...
<tr class="cssline">
    ...
    <td  class="container">
        <input type="password" name="password" id="password" value="${bean.password}" class="input_table" style="width:180px"/>&nbsp;如需修改密码，请填写;否则，请留空
    </td>
</tr>
<tr class="cssline">
    <td  class="csslabel">
    ...
    <td  class="container">
        <input type="password" name="password2" value="${bean.password2}" class="input_table" validType="equalTo['#password']" style="width:180px"/>&nbsp;
    </td>
</tr>
<tr class="cssline">
    <td  class="csslabel">
