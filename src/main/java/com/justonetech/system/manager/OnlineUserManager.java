...
public class OnlineUserManager {
     ...
     public List<Map> getRows(List<CountUser> onlineUsers) throws Exception {
        ...
        for (CountUser onlineUser : onlineUsers) {
            ...
            map.put("userArea","");
            map.put("loginDate",DateTimeHelper.formatTimestamp(onlineUser.getLoginDate(), "YYYY-MM-DD HH:MM:SS"));
            map.put("lastActName","");
            map.put("onlineTime",(int) ((System.currentTimeMillis() - onlineUser.getLoginDate().getTime()) / 60000));
